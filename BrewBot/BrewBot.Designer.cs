namespace BrewBot
{
	partial class BrewBot
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BrewBot));
			this.buttonDoWork = new System.Windows.Forms.Button();
			this.textBoxTrafficLog = new System.Windows.Forms.TextBox();
			this.textBoxTrafficInput = new System.Windows.Forms.TextBox();
			...
			this.buttonPlayer4Finish = new System.Windows.Forms.Button();
			this.buttonPlayer4GetTicket = new System.Windows.Forms.Button();
			this.buttonPlayer3Finish = new System.Windows.Forms.Button();
			this.buttonPlayer3GetTicket = new System.Windows.Forms.Button();
			this.buttonPlayer2Finish = new System.Windows.Forms.Button();
			this.buttonPlayer2GetTicket = new System.Windows.Forms.Button();
			this.buttonPlayer1Finish = new System.Windows.Forms.Button();
			this.buttonPlayer1GetTicket = new System.Windows.Forms.Button();
			...
			this.buttonPlayer1Drink = new System.Windows.Forms.Button();
			this.buttonPlayer2Drink = new System.Windows.Forms.Button();
			this.buttonPlayer3Drink = new System.Windows.Forms.Button();
			this.buttonPlayer4Drink = new System.Windows.Forms.Button();
			...
			this.buttonAllDrink = new System.Windows.Forms.Button();
			...
			this.labelCustomPlayer = new System.Windows.Forms.Label();
			...
			this.buttonDoWork.Location = new System.Drawing.Point(149, 123);
			this.buttonDoWork.Name = "buttonDoWork";
			this.buttonDoWork.Size = new System.Drawing.Size(419, 30);
			...
			this.listBoxRaffle.Size = new System.Drawing.Size(560, 160);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.buttonDraw.Location = new System.Drawing.Point(8, 203);
			...
			this.buttonClear.Location = new System.Drawing.Point(499, 203);
			...
			this.buttonSend.Click += new System.EventHandler( this.buttonSendRaw_Click );
			// 
			// tabControlConnected
			// 
			...
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer4Finish, 4, 4);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer4GetTicket, 3, 4);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer3Finish, 4, 3);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer3GetTicket, 3, 3);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer2Finish, 4, 2);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer2GetTicket, 3, 2);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer1Finish, 4, 1);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer1GetTicket, 3, 1);
			this.tableLayoutPanelDrinking.Controls.Add(this.textBoxPlayer1, 1, 1);
			this.tableLayoutPanelDrinking.Controls.Add(this.textBoxPlayer2, 1, 2);
			this.tableLayoutPanelDrinking.Controls.Add(this.textBoxPlayer3, 1, 3);
			this.tableLayoutPanelDrinking.Controls.Add(this.textBoxPlayer4, 1, 4);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer1Drink, 2, 1);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer2Drink, 2, 2);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer3Drink, 2, 3);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonPlayer4Drink, 2, 4);
			this.tableLayoutPanelDrinking.Controls.Add(this.comboBoxViewer, 1, 5);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelPlayer1, 0, 1);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelPlayer2, 0, 2);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelPlayer3, 0, 3);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelPlayer4, 0, 4);
			this.tableLayoutPanelDrinking.Controls.Add(this.checkBoxPlay, 0, 0);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonAllDrink, 1, 0);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelCustom, 0, 7);
			this.tableLayoutPanelDrinking.Controls.Add(this.comboBoxCustom, 1, 7);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonRemove, 4, 7);
			this.tableLayoutPanelDrinking.Controls.Add(this.buttonAdd, 3, 7);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelCustomName, 1, 6);
			this.tableLayoutPanelDrinking.Controls.Add(this.labelCustomPlayer, 2, 6);
			this.tableLayoutPanelDrinking.Controls.Add(this.comboBoxCustomPlayer, 2, 7);
			...
			this.tableLayoutPanelDrinking.RowCount = 8;
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 30F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 20F));
			this.tableLayoutPanelDrinking.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 16.66667F));
			...
			this.labelViewer.Location = new System.Drawing.Point(14, 176);
			...
			this.buttonPlayer4Finish.Click += new System.EventHandler(this.buttonPlayerFinish_Click);
			// 
			// buttonPlayer4GetTicket
			// 
			...
			this.buttonPlayer4GetTicket.Text = "Get a Drink Ticket";
			this.buttonPlayer4GetTicket.UseVisualStyleBackColor = true;
			this.buttonPlayer4GetTicket.Click += new System.EventHandler(this.buttonPlayerGetTicket_Click);
			// 
			// buttonPlayer3Finish
			// 
			...
			this.buttonPlayer3Finish.Click += new System.EventHandler(this.buttonPlayerFinish_Click);
			// 
			// buttonPlayer3GetTicket
			// 
			...
			this.buttonPlayer3GetTicket.Text = "Get a Drink Ticket";
			this.buttonPlayer3GetTicket.UseVisualStyleBackColor = true;
			this.buttonPlayer3GetTicket.Click += new System.EventHandler(this.buttonPlayerGetTicket_Click);
			// 
			// buttonPlayer2Finish
			// 
			...
			this.buttonPlayer2Finish.Click += new System.EventHandler(this.buttonPlayerFinish_Click);
			// 
			// buttonPlayer2GetTicket
			// 
			...
			this.buttonPlayer2GetTicket.Text = "Get a Drink Ticket";
			this.buttonPlayer2GetTicket.UseVisualStyleBackColor = true;
			this.buttonPlayer2GetTicket.Click += new System.EventHandler(this.buttonPlayerGetTicket_Click);
			// 
			// buttonPlayer1Finish
			// 
			...
			this.buttonPlayer1Finish.Click += new System.EventHandler(this.buttonPlayerFinish_Click);
			// 
			// buttonPlayer1GetTicket
			// 
			...
			this.buttonPlayer1GetTicket.Text = "Get a Drink Ticket";
			this.buttonPlayer1GetTicket.UseVisualStyleBackColor = true;
			this.buttonPlayer1GetTicket.Click += new System.EventHandler(this.buttonPlayerGetTicket_Click);
			// 
			// textBoxPlayer1
			// 
			...
			this.textBoxPlayer3.Text = "3";
			this.textBoxPlayer3.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// textBoxPlayer4
			// 
			...
			this.textBoxPlayer4.Text = "4";
			this.textBoxPlayer4.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			// 
			// buttonPlayer1Drink
			// 
			...
			this.buttonPlayer1Drink.Text = "Take a Drink";
			this.buttonPlayer1Drink.UseVisualStyleBackColor = true;
			this.buttonPlayer1Drink.Click += new System.EventHandler(this.buttonPlayerDrink_Click);
			// 
			// buttonPlayer2Drink
			// 
			...
			this.buttonPlayer2Drink.Text = "Take a Drink";
			this.buttonPlayer2Drink.UseVisualStyleBackColor = true;
			this.buttonPlayer2Drink.Click += new System.EventHandler(this.buttonPlayerDrink_Click);
			// 
			// buttonPlayer3Drink
			// 
			...
			this.buttonPlayer3Drink.Text = "Take a Drink";
			this.buttonPlayer3Drink.UseVisualStyleBackColor = true;
			this.buttonPlayer3Drink.Click += new System.EventHandler(this.buttonPlayerDrink_Click);
			// 
			// buttonPlayer4Drink
			// 
			...
			this.buttonPlayer4Drink.Text = "Take a Drink";
			this.buttonPlayer4Drink.UseVisualStyleBackColor = true;
			this.buttonPlayer4Drink.Click += new System.EventHandler(this.buttonPlayerDrink_Click);
			// 
			// comboBoxViewer
			// 
			...
			this.buttonAllDrink.Click += new System.EventHandler(this.buttonAllDrink_Click);
			// 
			// labelCustom
			// 
			...
			this.labelCustomName.Text = "Player Name";
			// 
			// labelCustomPlayer
			// 
			...
			// 
			// comboBoxCustomPlayer
			// 
			this.comboBoxCustomPlayer.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			...
			this.comboBoxCustomPlayer.SelectedIndexChanged += new System.EventHandler(this.comboBoxCustomPlayer_SelectedIndexChanged);
			// 
			// tabPageTraffic
			// 
			this.tabPageTraffic.Controls.Add(this.buttonSend);
			this.tabPageTraffic.Controls.Add(this.textBoxTrafficInput);
			this.tabPageTraffic.Controls.Add(this.textBoxTrafficLog);
			...
			// 
			this.loadCredentialsButton.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.loadCredentialsButton.Location = new System.Drawing.Point(149, 149);
			this.loadCredentialsButton.Name = "loadCredentialsButton";
			this.loadCredentialsButton.Size = new System.Drawing.Size(419, 30);
			this.loadCredentialsButton.TabIndex = 25;
			this.loadCredentialsButton.Text = "Load Credentials";
			...
			this.saveCredentialsCheckbox.Location = new System.Drawing.Point(15, 162);
			this.saveCredentialsCheckbox.Name = "saveCredentialsCheckbox";
			this.saveCredentialsCheckbox.Size = new System.Drawing.Size(106, 17);
			...
			// ConfigFileButton
			// 
			this.ConfigFileButton.Location = new System.Drawing.Point(149, 101);
			this.ConfigFileButton.Name = "ConfigFileButton";
			this.ConfigFileButton.Size = new System.Drawing.Size(419, 27);
			this.ConfigFileButton.TabIndex = 23;
			this.ConfigFileButton.Text = "Select Configuration File (Optional)";
			...
			this.Name = "BrewBot";
			this.Text = "BrewBot";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.BrewBot_FormClosed);
		...
		private System.Windows.Forms.TextBox textBoxTrafficLog;
		private System.Windows.Forms.TextBox textBoxTrafficInput;
		...
		private System.Windows.Forms.Button buttonPlayer1Drink;
		private System.Windows.Forms.Button buttonPlayer2Drink;
		private System.Windows.Forms.Button buttonPlayer4Finish;
		private System.Windows.Forms.Button buttonPlayer4GetTicket;
		private System.Windows.Forms.Button buttonPlayer3Finish;
		private System.Windows.Forms.Button buttonPlayer3GetTicket;
		private System.Windows.Forms.Button buttonPlayer2Finish;
		private System.Windows.Forms.Button buttonPlayer2GetTicket;
		private System.Windows.Forms.Button buttonPlayer1Finish;
		private System.Windows.Forms.Button buttonPlayer1GetTicket;
		private System.Windows.Forms.Button buttonPlayer3Drink;
		private System.Windows.Forms.Button buttonPlayer4Drink;
		...
		private System.Windows.Forms.Button buttonAllDrink;
